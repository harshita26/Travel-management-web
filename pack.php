            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-9 text-center">
                        ...
                        <?php $sids=$_GET['sid'];
                        $qury="SELECT * FROM `package` WHERE `sid`='$sids';";
                        $runs=mysqli_query($conn,$qury);
                        while($d=mysqli_fetch_array($runs)){
                            ?><div class="card float-left w-50">
                            <div class="card-header"><?php echo $d[1];?></div>
                            <div class="card-body"><img src="images/package/<?php echo $d[5];?>" class='img-fluid'alt=""></div>
                            <div class="card-footer" ><a href="detail.php?pid=<?php echo $d[0];?>">View Details</a></div>
                            </div>
                            <?php
                        }?>
                    </div>
